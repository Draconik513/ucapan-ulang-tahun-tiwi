...
const CakeCelebration = () => {
  ...
  const extinguishFlame = () => {
    ...
    // Tampilkan confetti setelah 500ms
    setTimeout(() => {
    ...
    if (birthdaySongRef.current) {
      birthdaySongRef.current.play().catch(error => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-pink-900 to-purple-900 flex flex-col items-center justify-center p-4 relative overflow-hidden">
      {showConfetti && (
        <Confetti
          width={width}
          height={height}
